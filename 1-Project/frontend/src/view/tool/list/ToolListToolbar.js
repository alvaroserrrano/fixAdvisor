...
class ToolToolbar extends Component {
  doExport = () => {
    ...
    return (
      <Toolbar>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Link to="/audit-logs?entityNames=tool">
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: toolSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: toolSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(ToolToolbar);
